...
/** Close financial audit tasks when a rent invoice already exists or was paid. */
export async function resolveStaleFinancialAuditActionItems(): Promise<{ resolved: number }> {
...
export async function syncActionItems(session: AdminSession): Promise<void> {
  ...
  await resolveStaleFinancialAuditActionItems();
