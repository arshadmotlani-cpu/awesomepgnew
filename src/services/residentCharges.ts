...
import { depositLinkWithoutActiveRejectionSql, depositLinkWithoutSucceededProofPaymentSql } from '@/src/lib/operations/paymentReviewQueueEligibility';
  ...
  return db
    ...
    .where(
      and(
        ...
        depositLinkWithoutActiveRejectionSql(),
        or(
