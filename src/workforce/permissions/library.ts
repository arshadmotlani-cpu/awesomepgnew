...
export const WORKFORCE_PERMISSION_LIBRARY: readonly WorkforcePermissionDef[] = [
  ...
  // Staff
  { key: 'staff.view', label: 'View Staff', group: 'staff', description: 'See team roster and profiles' },
  { key: 'staff.edit', label: 'Manage Staff', group: 'staff', description: 'Add, edit or deactivate employees' },
  { key: 'staff.add', label: 'Add Staff', group: 'staff', description: 'Create new employee records' },
  { key: 'staff.view_financials', label: 'View Staff Financials', group: 'staff', description: 'See salary, incentives and deductions' },
  { key: 'attendance.view_own', label: 'Own Attendance', group: 'staff', description: 'View your own attendance' },
  { key: 'attendance.mark', label: 'Mark Attendance', group: 'staff', description: 'Mark your own daily attendance' },
  { key: 'attendance.view_team', label: 'View Team Attendance', group: 'staff', description: "See everyone's attendance" },
  { key: 'attendance.correct', label: 'Correct Attendance', group: 'staff', description: 'Fix attendance with reason + audit trail' },
  { key: 'attendance.manage_office', label: 'Manage Office Location', group: 'settings', description: 'Set the office GPS location for attendance' },
  // Reports / Analytics
  ...
  // Finance / payroll
  { key: 'finance.view_salary', label: 'View Salary', group: 'staff', description: 'See employee salary calculations' },
  { key: 'finance.manage_salary', label: 'Manage Salary', group: 'staff', description: 'Generate/finalize payroll and manage salary records' },
  { key: 'finance.pay_salary', label: 'Pay Salary', group: 'staff', description: 'Record salary payments to employees' },
  { key: 'finance.view_salary_qr', label: 'View Salary QR', group: 'staff', description: 'See employee UPI/payment QR for salary' },
  { key: 'finance.view_own_salary', label: 'View Own Salary', group: 'staff', description: 'See your own salary only' },
  { key: 'payroll.view_reports', label: 'View Payroll Reports', group: 'reports', description: 'See salary/payment reports' },
