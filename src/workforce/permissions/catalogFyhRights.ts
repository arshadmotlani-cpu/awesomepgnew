...
export const FYH_RIGHTS_CATALOG: readonly Def[] = [
  ...
  def(
    ...
    'Expenses on dashboard',
    'dashboard',
    'Expense widgets and summaries on the dashboard',
    'dashboard',
    'expenses',
    'view',
  ),
  def(
    ...
    'dashboard',
    'Appointment widgets and summaries on the dashboard',
    'dashboard',
    'appointments',
    'view',
  ),
  def('customers.view', 'View customers', 'customers', 'Full customer profile wherever shown', 'customers', 'customer', 'view'),
  ...
  def('reports.view', 'View reports', 'reports', 'Access reports and analytics', 'reports', 'catalog', 'view'),
  def('reports.edit', 'Edit reports', 'reports', 'Adjust report configuration where supported', 'reports', 'catalog', 'edit'),
  def('reports.export', 'Export reports', 'reports', 'Download CSV and spreadsheet exports', 'reports', 'catalog', 'export'),
];
