...
export const V2_TO_V1_ALIASES: Record<string, readonly WorkforcePermissionKey[]> = {
  ...
  'appointments.appointment.create': ['appointments.add', 'appointments.edit'],
  ...
  'quick_sale.access': ['billing.bill.create', 'billing.create_invoice', 'billing.edit_invoice'],
  ...
  'billing.invoice.view': ['billing.invoices.view', 'billing.view'],
  'billing.invoice.create': ['billing.bill.create', 'billing.create_invoice'],
  'billing.invoice.edit': ['billing.bill.edit', 'billing.edit_invoice'],
...
export const LEGACY_HAIR_TO_V2: Record<HairPermission, readonly string[]> = {
  ...
  'page:expenses': ['expenses.general.view', 'expenses.salary.view', 'expenses.expense.view'],
  'page:reports': ['reports.view', 'reports.revenue.view'],
  'page:settings': ['settings.view', 'configuration.view'],
  'page:staff': ['staff.view', 'staff.profile.view'],
