...
export function FyhSidebarBrand({ className }: { className?: string }) {
  return (
    <div className={['flex h-11 items-center gap-2 border-b border-[color:var(--fyh-border)] px-2.5', className].filter(Boolean).join(' ')}>
      <FyhMark size={30} className="shrink-0 shadow-lg shadow-black/30" />
