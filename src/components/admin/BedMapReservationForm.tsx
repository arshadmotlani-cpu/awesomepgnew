    ...
    return (
      ...
      >
        ...
        <AdminConfirmSubmit
          ...
          description="The bed will show as bookable on the website until the move-in date you picked. The tenant is not marked as living there yet."
          confirmLabel="Mark as reserved"
          pending={pending}
  ...
  return (
    ...
    >
      ...
      <AdminConfirmSubmit
        ...
        description="This marks the tenant as living in the bed from today. The bed will no longer appear as bookable."
        confirmLabel="Moved in today"
        pending={pending}
