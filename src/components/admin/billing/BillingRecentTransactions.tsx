...
export function BillingRecentTransactions({
  rows,
  error,
}: {
  rows: PaidRow[];
    ...
    return (
      <section className="mb-8">
        <header className="mb-4">
          ...
          <p className="mt-1 text-sm text-apg-silver">Recently paid rent bills.</p>
        </header>
  ...
  return (
    <section className="mb-8">
      <header className="mb-4 flex flex-wrap items-end justify-between gap-2">
        <div>
          <h2 className="text-base font-semibold text-white">Recent transactions</h2>
          <p className="mt-1 text-sm text-apg-silver">Rent bills marked paid — read only.</p>
        </div>
        <Link
