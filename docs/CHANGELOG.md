...
### Pending pre-commit sync · 2026-08-15 15:47:18 UTC

**Areas touched:** [[ROUTES]], [[Billing]], [[Action Center]]
...
- `src/lib/billing/adminWhatsApp.ts`
- `src/lib/billing/collectionsQueue.ts`
- `src/lib/billing/monthlyBillingSnapshot.ts`
- `src/lib/billing/rentInvoiceBreakdownTypes.ts`
