...
### Pending pre-commit sync · 2026-06-29 18:41:30 UTC
...
**Staged code files (4):**
- `app/(customer)/account/profile/developer-test-actions.ts`
- `app/(customer)/account/resident/request-actions.ts`
- `src/lib/auth/developerTestResident.server.ts`
- `src/lib/auth/developerTestResident.shared.ts`
