...
### Pending pre-commit sync · 2026-07-31 02:33:53 UTC
...
- `app/(hair)/fyh/(public)/i/[invoiceNumber]/page.tsx`
- `app/(hair)/fyh/(public)/invoice/[invoiceNumber]/page.tsx`
- `app/(hair)/fyh/(public)/layout.tsx`
- `app/(hair)/fyh/api/invoices/public/[invoiceNumber]/print/route.ts`
