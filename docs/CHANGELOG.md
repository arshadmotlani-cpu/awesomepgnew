...
### Pending pre-commit sync · 2026-09-02 20:43:14 UTC
...
- `src/lib/billing/assertElectricityBreakdownCommitReady.ts`
...
- `src/lib/billing/electricityOccupancyEligibility.ts`
...
- `src/lib/billing/roomElectricityTimeline.ts`
