...
### Pending pre-commit sync · 2026-06-30 11:14:13 UTC

**Areas touched:** [[ROUTES]], [[DATABASE]], [[Vacating]], [[Electricity]]
...
- `src/db/migrations/0084_electricity_settlement_ledger.sql`
- `src/db/migrations/meta/_journal.json`
- `src/db/schema/electricityBills.ts`
- `src/db/schema/electricitySettlementLedger.ts`
