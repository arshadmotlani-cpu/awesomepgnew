...
### Pending pre-commit sync · 2026-09-08 12:22:00 UTC
...
**Staged code files (4):**
- `app/(hair)/fyh/(app)/attendance/manage/page.tsx`
- `app/(hair)/fyh/(app)/attendance/map/page.tsx`
- `app/(hair)/fyh/(app)/attendance/page.tsx`
- `app/(hair)/fyh/(app)/settings/attendance/page.tsx`
