...
export default async function RevenueResidentPage({
  ...
  await requireAdminSession('/admin/operations');
    ...
    <>
      <ModuleBreadcrumbs
        items={[
          ...
          { label: ADMIN_MODULES.operations.label, href: moduleHref('operations', billingMonth) },
          { label: pg.name, href: modulePgHref('operations', pgId, billingMonth) },
          { label: residentName },
        ]}
      />
      <PageHeader
