...
export default async function AccessDeniedPage() {
  ...
  const home = await resolveSessionDefaultLandingPath(admin);
  ...
  return (
    <div className="mx-auto flex min-h-[50vh] max-w-lg flex-col items-center justify-center space-y-4 text-center">
      ...
      <h1 className="fyh-display text-2xl font-semibold text-fyh-text">Access denied</h1>
      <p className="text-sm text-fyh-text-secondary">
        You don&apos;t have permission to access this page. Contact your salon owner if you need
        additional rights.
      </p>
      <Link
        href={home}
