...
async function main() {
  ...
  console.log('June 2026 electricity bill batch');
  console.log(`PG filter: ${pgQuery}`);
  console.log(`Billing month: ${BILLING_MONTH}`);
  console.log(`Rate: ${paiseToInr(RATE_PAISE)} per unit`);
